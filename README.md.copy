...
12/14: [Visualization](#class-5-visualization) | 12/16: [Getting Data](#class-6-machine-learning)
12/21: [Machine Learning](#class-7-getting-data) | 12/23: No Class
...
01/25: [Snow Day]() | 01/27: [Natural Language Processing](#class-15-natural-language-processing)
02/01: [NLP II]()| 02/03: [Decision Trees](#class-17-decision-trees)
02/08: [Ensembling](#class-118-ensembling)  |  02/10: [Unsupervised Learning]()
02/15: No Class |  02/17: Elective Topics 
02/22: Final Project Presentations  | 02/24 Final Project Presentations
...
* Review projects [timeline](project/README.md)
...
### Class 3: Python Fundamentals, Data Reading and Cleaning
* Review command line homework ([solution](homework/02_command_line_chipotle.md))
* Python Fundamentals
  * Python interfaces (shell, script, IDEs, notebooks)
  * Fundamental programming concepts ([notebook](notebooks/02_python_fundamentals.ipynb))
  * Extra Python [review](code/00_python_intermediate_workshop.py) 
  * Talk through Python homework with Chipotle data ([code](code/03_python_homework_chipotle.py), [data](data/chipotle.tsv), [article](http://www.nytimes.com/interactive/2015/02/17/upshot/what-do-people-actually-order-at-chipotle.html))
* Pandas (time permitting)


**Homework:**
* Complete the [Python homework assignment](code/03_python_homework_chipotle.py) (**Note:** Pandas, which is covered in class 4, should not be used for this assignment.)
* After you're done (or have tried your best), read through the [detailed answers](notebooks/03_python_homework_chipotle_explained.ipynb) for the assignment. Identify points where you had trouble and identify things you learned. 
...
* Pandas ([code](notebooks/04_pandas.ipynb)):
...
**Homework:**
* Over the weekend, reread the [Python](notebooks/02_python_fundamentals.ipynb) and [Pandas](notebooks/04_pandas.ipynb) notebooks, making sure to work through any concepts, examples, or exercises that we skipped in class. 
* The deadline for discussing your project ideas with an instructor is December 14, and your project question write-up is due December 21.
...
* Visualization with Pandas and Matplotlib ([notebook](notebooks/05_visualization.ipynb))

**Homework:**
* Your project question write-up is due next Monday.
* Complete the [Pandas homework assignment](homework/05_pandas_and_viz.md) with the [IMDb data](data/imdb_1000.csv). Due in a week.
* Once you're done (or have tried your best), look through the [solutions] (homework/solutions/05_pandas_homework_imdb.py).
* Read this (blog post)[http://fivethirtyeight.com/features/fandango-movies-ratings/], we will discuss it next time.
...
### Class 6: Getting Data APIs and Web Scraping
* Discuss [538 Article](http://fivethirtyeight.com/features/fandango-movies-ratings/)
* APIs ([notebook](notebooks/06_api.ipynb))
    * [OMDb API](http://www.omdbapi.com/)
* Web scraping ([notebook](code/06_web_scraping.ipynb))
...
**Homework:**
* Project Question due Monday. Some examples:
...
* "Human learning" exercise:
    ...
    * [Notebook](notebooks/07_human_learning_iris.ipynb)
* Introduction to machine learning ([slides](slides/06_machine_learning.pdf))
* K Nearest Neighbors ([notebook](notebooks/08_knn_sklearn.ipynb))

**Homework:**
* **Optional:** Complete the bonus exercise listed in the [human learning notebook](notebooks/06_human_learning_iris.ipynb). 
* No class on Wednesday, so don't show up because the lights will be off. 
* Use this extra time to practice basic Python and pandas skills. Plenty of look-ahead reading below:
...
### Class 8: K-Nearest Neighbors & ScikitLearn
* K-nearest neighbors and scikit-learn ([notebook](notebooks/08_knn_sklearn.ipynb))
* KNN Exercise with NBA player data ([notebook](notebooks/08_nba_knn.ipynb), [data](https://github.com/justmarkham/DAT4-students/blob/master/kerry/Final/NBA_players_2015.csv), [data dictionary](https://github.com/justmarkham/DAT-project-examples/blob/master/pdf/nba_paper.pdf))
* Intro to Bias and Variance ([notebook](notebooks/08_bias_variance.ipynb))
...
* Work on your project, first presentations coming up soon!  
* **Optional** If you're feeling on-top of the material and want to learn something new, work through this notebook about [KNN on images of faces](homework/09_knn_faces.ipynb). This is a fun application of KNN Regression to a problem in image processing and prediction. 
...
**Homework:**
* Your first project presentation is on Wednesday! If you're storing your project work in a repo other than your ga_hw repo, please submit a link to your project repository (with slides, code, data, and visualizations) before the start of class.
* Complete the [homework assignment](homework/10_yelp_votes.md) with the [Yelp data](data/yelp.csv). This is due in a week.
...
**Homework:**
* The Yelp [homework assignment](homework/10_yelp_votes.md) is due on Monday. Once you've tried your best, take a look at this [answer key](homework/solutions/10_yelp_homework.ipynb) and make sure everything makes sense to you. 
...
* If it has been many years since you've encountered the logarithm function, then read these excellent articles from BetterExplained: [An Intuitive Guide To Exponential Functions & e](http://betterexplained.com/articles/an-intuitive-guide-to-exponential-functions-e/) and [Demystifying the Natural Logarithm (ln)](http://betterexplained.com/articles/demystifying-the-natural-logarithm-ln/). Then, review this [brief summary](notebooks/12_e_log_examples.ipynb) of exponential functions and logarithms.
...
**Homework:**
* Work through the notebook on [Cross-validation](notebooks/13_cross_validation.ipynb)
...
**Homework:**
* Complete another [homework assignment](homework/14_yelp_review_text.md) with the [Yelp data](data/yelp.csv). This is due in a week. Once you've tried your hardest, you can look to the [answer key](homework/solutions/14_yelp_review_text.ipynb)
...
**Homework:**
* Complete the text [homework assignment](homework/14_yelp_review_text.md) with the [Yelp data](data/yelp.csv). This is due in a week. Once you've tried your hardest, you can look to the [answer key](homework/solutions/14_yelp_review_text.ipynb).
* Work on your projects. You should probably have tried out some models by now and started to compare techniques. We're going to forego the lengthy write-up aspect of this project and focus all of our efforts on the final presentation. 
* Next week, we're going to do a quick in-class peer review and discussion of our projects. Spend a few minutes thinking about the challenges you've encountered so far and what areas you might like to get peer feedback on. Putting together a few visuals/slides would be helpful for the conversation.  
...
* In-class Peer Review and Discussions
    * Within your groups, each person should take turns presenting an update about the status of their project. Go through some visuals and/or some code and discuss the directions you're heading. Make sure you discuss roadblocks you have hit and the paths you have taken to overcome them. Discuss any current roadblocks and see if the group can come up with new perspectives and ideas. Describe where you intend to go next with your project. Seek feedback from your group about what components of your project plan are unclear or confusing. 
...
### Class 18: Ensembling
* Finish decision trees lesson and exercise ([notebook](notebooks/17_decision_trees.ipynb))
...
**Homework:**
* There's not really going to be much more homework for the rest of the course. Work on your projects!
...
### Class 19: Unsupervised Learning
...
* Topic Modeling
  * Latent Dirichlet Allocation [notebook](notebooks/19_LDA)
  * LDA Visualization
    * [Hacker News Example](http://nbviewer.jupyter.org/github/bmabey/hacker_news_topic_modelling/blob/master/HN%20Topic%20Model%20Talk.ipynb)
...
### Class 20: Spark and Neural Networks
* Apache Spark 
    * [Slides](slides/20_ApacheSpark.pdf)
    * [Notebook](notebooks/20_spark.ipynb)
* Neural Networks
    * [Slides](slides/20_NNs.pdf)
    * [Notebook](notebooks/20_neural_networks.ipynb)

**Neural Network Resources:**
  * Great tutorials about deep learning and the Theano library at http://deeplearning.net/tutorial/
