# CHAL #4: isupper(), isalpha(), boolean logic, string slicing
# linkedlist.html
s = \
"""
...
for i in range(3,len(s)):
   ...
   if o in range(97,123):
       ...
       pos = s[i+1:i+4]
       #print sub + " " + s[i] + " " + pos
       if (sub.isupper() & sub.isalpha() & pos.isupper() & pos.isalpha()):
           #print "appending: ", sub, s[i], pos
           if s[i+4].islower() & s[i-4].islower():
               l_str.append(sub+s[i]+pos)
           else:
               r_str.append(sub+s[i]+pos)
